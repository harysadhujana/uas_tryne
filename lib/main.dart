...
import 'package:uas_hary/app_color.dart';
import 'package:uas_hary/create_task_screen.dart';
import 'package:uas_hary/widget_background.dart';
        ...
        onPressed: () async {
          ...
          if (result != null && result) {
            scaffoldState.currentState.showSnackBar(SnackBar(
              content: Text('Produk telah dibuat'),
            ));
            setState(() {});
          }
        },
  ...
  Container _buildWidgetListTodo(double widthScreen, double heightScreen, BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            padding: const EdgeInsets.only(left: 120.0, top: 16.0),
            child: Text(
              'Harsans FC',
              style: Theme
                  .of(context)
                        ...
                        trailing: PopupMenuButton(
                          ...
                          onSelected: (String value) async {
                            if (value == 'edit') {
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState.showSnackBar(SnackBar(
                                  content: Text('Produk diperbaharui'),
                                ));
                                setState(() {});
                              }
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Ingin Menghapus ${task['name']}?'),
                                    actions: <Widget>[
                                      FlatButton(
                                        child: Text('No'),
                                        onPressed: () {
